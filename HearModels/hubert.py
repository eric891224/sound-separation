...
def load_model(model_file_path: str = "", model_type: str = "hubert_large_ll60k") -> torch.nn.Module:
	"""
	...
	model = S3PRLUpstream(model_type, refresh=False)
	...
	elif model_type == "hubert_large_ll60k":
